...
<form class="layui-form bform" method="post" action="${ctx}/backend/article/addAjax" enctype="multipart/form-data">
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      <textarea id="editor" name="content" placeholder="请输入内容" autofocus="true" class="layui-textarea"></textarea>
    </div>
  </div>
